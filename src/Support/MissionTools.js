                           ...
                           <div className="col-md-7 text-center">
                               ...
                               <p className="paragrafo fs-5">
                                   Toda igreja pode ser missionária? <br />
                                    Que marcas uma igreja precisa ter para cumprir o seu papel?<br />
                                    Como gerar paixão nos membros da igreja para enviar pessoas e 
                           ...
                           <div className="col-md-7 text-center">
                               ...
                               <p className="paragrafo fs-5">
                                   O QUE VAMOS VER NESSA AULA? <br />
                                    1. O que é ser um vocacionado?<br />
                                    2. Que orientação a sua igreja pode oferecer para um vocacionado?<br />
                                    3. Como acompanhar esse vocacionado até chegar ao campo missionário?
                               </p>
                               </div>
                           </div>
                        </div>
