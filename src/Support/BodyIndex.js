  ...
  return (
    <main id="home">
      ...
      <div className="bg-full">
        ...
        <section id="doar" className="d-flex justify-content-center align-items-center pb-5">
              ...
              <div className="row gx-2 text-center">
                ...
                <div className="col-12 col-sm-6">
                  <div className="box p-3 m-3 border border-dark border-2 bg-light rounded-3">
                    <p className="h2 title fw-bolder text-center">Ore por Missões</p>
                    <p className="paragrafo fs-5 mt-4 text-center">
                      ...
                      possam resistir, permanecendo firme na fé.
          ...
          <div className="bg-2 rounded-3 d-flex justify-content-center align-items-center animate__animated animate__flipInX">
            <div className="box-one border border-dark p-3 m-3 bg-box rounded-3">
              ...
              <p className="paragrafo fs-5 mt-4 text-center">
                ...
                Somos o Ministério de Missões. <strong>Nossa razão </strong>é manter acesa e ampliar a visão missionária da igreja. Temos como missão cuidar da
