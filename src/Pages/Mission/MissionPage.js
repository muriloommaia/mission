...
export const MissionPage = ({ MISSIONARY, PROJECT }) => {
    ...
    <div className="container-fluid">
      ...
      <div className="text-center">
        <div className="rows">
          <img
            src={
              require("../../imgs/logotipo_lideres_de_missoes-removebg-preview.png")
                .default
            }
            alt="'"
          />
                  ...
                  <>
                    <div key={idx} className="cards rounded-3 bg-card">
                      <img
                        ...
                        alt={Cards[idx].name}
                      />
                      <h4 className="paragrafo fs-3 mt-2 fw-bold">
                        {Cards[idx].name}
                      </h4>
                      ...
                      <button
                        type="button"
                        className="paragrafo mt-2 btn btn-primary mb-2 bottom"
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content">
                          ...
                          <div className="modal-body">
                            ...
                            <p className="paragrafo fs-5 mt-0">
                              {Cards[idx].local}
                            </p>
                            <hr />
                            <p className="paragrafo mt-0 mb-0">
                              Para conhecer os pedidos de oração clique abaixo!
                            </p>
                          </div>
                          <div className="modal-footer">
                            <a
                              type="button"
                              className="btn btn-primary paragrafo"
                              target="_blank"
                              href={Cards[idx].link}
                              rel="noreferrer"
                            >
                            ...
                            <button
                              type="button"
                              className="btn btn-secondary paragrafo"
                              data-bs-dismiss="modal"
                            >
                              Fechar
                            </button>
          ...
          {PROJECT.map((item, idx) => {
            return (
              <>
                <div
                  key="{idx}"
                  className="cards rounded-3 bg-card border-dark"
                >
                  <img
                    className="border border-2 border-secondary"
                    src={PROJECT[idx].img}
                    alt={PROJECT[idx].name}
                    width="200px"
                    height="200px"
                  />
                  <h4 className="paragrafo fs-3 mt-2 fw-bold">
                  ...
                  <button
                    ...
                    className="paragrafo mt-2 btn btn-primary mb-2 bottom"
                    data-bs-toggle="modal"
                    data-bs-target={"#projectModel-" + idx}
                  >
                    Conhecer mais!
                  </button>
                </div>
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        ...
                        <a
                          target="_blank"
                          href={PROJECT[idx].local}
                          className="paragrafo fs-5 mt-0"
                          rel="noreferrer"
                        >
                          {PROJECT[idx].local}
                        </a>
